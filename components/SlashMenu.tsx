...
export const SLASH_COMMANDS: SlashCommand[] = [
  // === Améliorer ===
  { id: 'hook',          trigger: 'hook',          label: 'Améliorer le hook',         hint: 'Plus accrocheur, factuel, < 80 chars',                group: 'Améliorer', prompt: 'Améliore le hook (1ère phrase) : rends-le plus accrocheur, < 80 caractères, factuel, sans clickbait. Garde tout le reste du post.' },
  { id: 'raccourcir',    trigger: 'raccourcir',    label: 'Raccourcir',                hint: '600-700 chars en gardant l\'essentiel',               group: 'Améliorer', prompt: 'Raccourcis ce post à 600-700 caractères en préservant l\'essentiel et un exemple chiffré.' },
  { id: 'plus-direct',   trigger: 'plus-direct',   label: 'Plus direct',               hint: 'Couper les filler, aller droit au but',               group: 'Améliorer', prompt: 'Rends ce post plus direct : supprime les filler words, les phrases d\'intro lentes, va droit au but dès la 1ère ligne.' },
  { id: 'plus-concret',  trigger: 'plus-concret',  label: 'Plus concret',              hint: 'Ajouter exemple chiffré ou cas anonymisé',            group: 'Améliorer', prompt: 'Rends ce post plus concret : ajoute un exemple chiffré, un cas anonymisé, des paragraphes plus courts.' },
  { id: 'plus-premium',  trigger: 'plus-premium',  label: 'Plus premium',              hint: 'Ton expert, mature, sans jargon',                     group: 'Améliorer', prompt: 'Rends ce post plus premium : ton expert mature, vocabulaire précis sans jargon technique, structure plus serrée. Style Linear / Lemlist landing page.' },
  { id: 'supprimer-ia',  trigger: 'supprimer-ia',  label: 'Supprimer style IA',        hint: 'Tirets longs, mots creux, formules signatures',        group: 'Améliorer', prompt: 'Retire tout style IA reconnaissable : tirets longs, mots creux (seamless/robust/delve), formules signature, "ce n\'est pas X c\'est Y".' },
  // === Reformater ===
  { id: 'aerer',         trigger: 'aerer',         label: 'Aérer les paragraphes',     hint: 'Lignes vides entre les blocs',                         group: 'Format',    prompt: 'Aère ce post : ajoute des lignes vides entre les paragraphes, casse les longues phrases.' },
  { id: 'thread',        trigger: 'thread',        label: 'Convertir en thread',       hint: '4-6 messages liés',                                    group: 'Format',    prompt: 'Convertis ce post en thread LinkedIn de 4-6 messages liés. Chaque message numéroté X/N, autonome mais cohérent.' },
  { id: 'carrousel',     trigger: 'carrousel',     label: 'Convertir en carrousel',    hint: '6 slides : problème, contexte, 3 leçons, CTA',         group: 'Format',    prompt: 'Convertis ce post en plan de carrousel 6 slides : Slide 1 problème, Slide 2 contexte, Slides 3-5 trois leçons, Slide 6 CTA. Donne le texte exact de chaque slide.' },
  // === Angle ===
  { id: 'opinion',       trigger: 'opinion',       label: 'Convertir en opinion',      hint: 'Hot take mesuré sur ce sujet',                         group: 'Angle',     prompt: 'Réécris ce post en mode opinion : hot take mesuré sur ce sujet, position claire en 1ère phrase, exemple à l\'appui, sans gratuité.' },
  { id: 'storytelling',  trigger: 'storytelling',  label: 'Convertir en storytelling', hint: 'Acte 1 contexte, acte 2 conflit, acte 3 résolution',  group: 'Angle',     prompt: 'Réécris ce post en storytelling 3 actes : Acte 1 contexte (qui, où, quand), Acte 2 conflit (le problème), Acte 3 résolution (la leçon). Format narratif.' },
          ...
          <div key={groupName}>
            ...
            {list.map(c => {
              ...
              return (
                ...
                >
                  <span className={`w-1.5 h-1.5 rounded-full mt-2 shrink-0 ${GROUP_DOT[c.group || ''] || 'bg-ink-400'}`} aria-hidden />
