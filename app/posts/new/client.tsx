      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <section className="space-y-4">
          <div className="bg-white rounded-2xl p-5 shadow-card ring-1 ring-inset ring-ink-300/20">
            ...
            <Label className="mt-4">Brief / pitch{prefillBrief && <span className="ml-2 text-[10px] uppercase tracking-wide font-semibold text-brand-700 bg-brand-50 px-1.5 py-0.5 rounded">Auto-suggéré</span>}</Label>
          ...
          <div className="bg-white rounded-2xl p-5 shadow-card ring-1 ring-inset ring-ink-300/20 space-y-2">
            <label className="flex items-start gap-3 cursor-pointer select-none p-2 rounded-lg ring-1 ring-ink-100 bg-warn-50/30">
              ...
              <span className="text-sm text-ink-700">
                <strong className="block text-ink-900">Validï¿½ pour publication automatique</strong>
                <span className="text-xs text-ink-500">Si cochï¿½, le cron quotidien publiera ce post ï¿½ l'heure programmï¿½e. Sinon il restera en draft, mï¿½me si la date est passï¿½e.</span>
              </span>
            </label>
