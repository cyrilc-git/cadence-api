    ...
    <div className="space-y-6">
      ...
      {filtered.length === 0
        ...
        : <div className="grid gap-2">
            {filtered.map(p => (
              <Link key={p.id} href={`/posts/new?from=${p.id}`} className="bg-white rounded-xl p-4 shadow-card ring-1 ring-inset ring-ink-300/20 hover:shadow-pop transition flex items-center gap-4">
